...
public class NewsFeedFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<NewsArticle>>, RecyclerAdapterNews.OnItemClickListener {
    ...
    private static final String NEWSFEED_REQUEST_URL = "http://api.mediastack.com/v1/news?&limit=40&keywords=covid&access_key=b8ece5446c9a4412e81f19a453371cb7";
    ...
    public Loader<List<NewsArticle>> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        /* Return the completed uri `http://api.mediastack.com/v1/news?&limit=40&keywords=covid&access_key=29cbba504148f7f072db97e861e3e95f&sort=published_desc&languages=en&countries=ca' */
